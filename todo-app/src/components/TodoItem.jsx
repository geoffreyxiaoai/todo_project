...
const formatTimeAgo = (timestamp) => {
  ...
  if (totalHours < 24) {
    return `${pluralize(totalHours, "hour")} ${pluralize(
      minutes,
      "minute"
    )} ago`;
  }
  ...
  return (
    <div
      className={clsx(
        ...
        todo.completed && "opacity-60 bg-gray-50 dark:bg-slate-800/60"
      )}
    >
        ...
        <button
          ...
          className={clsx(
            ...
            todo.completed
              ...
              : "border-gray-300 dark:border-slate-500 hover:border-blue-500 dark:hover:border-blue-400 text-transparent"
          )}
        >
      ...
      <button
        onClick={onDelete}
        className={clsx(
          "p-2 text-gray-400 dark:text-slate-500 hover:text-red-500 rounded-lg cursor-pointer",
